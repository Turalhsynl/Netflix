...
export const FAQitem = ({ item, openAccordion, setOpenAccordion }) => {
  ...
  return (
    ...
    >
      <div className="flex justify-between items-center border border-black px-[24px] py-[24px] hover:bg-white/30">
      ...
      {openAccordion === item.id && (
        <div className="text-white text-[1.5rem] pt-[16px] leading-[1.8] px-[24px] pb-[24px] border border-black">
